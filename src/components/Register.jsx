...
const Register = () => {
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center bg-main-100">
            <div className="relative mx-auto w-full max-w-xl bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10 my-8">
