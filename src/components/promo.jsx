...
const StorePromo = memo(() => {
  ...
  return (
    <section className="bg-main-100 py-8 max-lg:my-3 px-4 sm:px-6 md:px-10 lg:px-20 poppins">
      <div className="bg-main-200 lg:h-72  rounded-[2rem] flex flex-col md:flex-row items-center justify-between p-6 sm:p-8 md:p-6 lg:p-12 overflow-hidden relative mx-auto max-w-7xl">
        {/* Text Content */}
        <div className="w-full md:w-1/2 z-10 mb-6 md:mb-0">
          ...
          <p className="text-gray-700 text-sm sm:text-base mb-6">
            Use our Scan By Diet mobile app to find out—instantly whether the
