...
import {
  selectAuthError,
  selectAuthStatus,
} from "../selectors/authSelectors.jsx";
import { fetchCart } from "../features/cartSlice.jsx";
import { reloadFavorites } from "../features/favoritesSlice.jsx";
...
const Login = () => {
  ...
  return (
    <div className=" h-screen flex justify-center items-center bg-main-100">
      <div className="bg-white relative mx-auto   w-full max-w-lg  px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10 my-8">
