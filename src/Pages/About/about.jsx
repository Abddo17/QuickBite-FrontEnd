        ...
        >
            <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(to bottom, rgba(245, 236, 222, 0.8), rgba(245, 236, 222, 0.9))",
                    }}
                ></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-section">
                        ...
                        <div className="order-1 lg:order-2 relative">
                            <div className="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden shadow-xl">
                                <img
                                    src="https://images.unsplash.com/photo-1519996529931-28324d48471b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
                                    alt="Our Story"
                    ...
                    <a
                        ...
                        onMouseEnter={(e) => {
                            e.target.style.backgroundColor =
                                "var(--color-main-300)";
                            e.target.style.color = "var(--color-zinc)";
                        }}
                        onMouseLeave={(e) => {
                            e.target.style.backgroundColor =
                                "var(--color-primary-800)";
                            e.target.style.color = "var(--color-main-100)";
                        }}
                    >
                        Order Now
                    </a>
